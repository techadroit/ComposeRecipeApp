...
/**
 * ErrorResult Represent Data layer exceptions (Note : for domain and presentation layer we have [Failure]).
 ...
 */
object NoDataErrorResult : ErrorResult()

/**
 * Represent Io Exceptions
 */
object NetworkUnavailableErrorResult : ErrorResult()
