...
class HomeRecipeViewModelTest {
    ...
    @get: Rule
    val stateManagerTestRule = StateManagerTestRule()
    ...
    fun setUp() {
        ...
        viewModel =
            HomeRecipeViewModel(recipeWithCuisineUseCase, initialHomeState, testStateManagerScope,testStateManagerScope.testDispatcher)
    }
